  ...
  noexcept(false)
{
    ...
    //         input_dim       = 1;
    //       } else {
    //         throw InvalidDowncastException("Failed to downcast from Layer to
    //         Flatten (layer_name: " + flatten_layer->name() + ")");
    //       }
    //       break;
    ...
    //         encrypted_units =
    //         global_average_pooling2d_layer->flatten(encrypted_3d); input_dim
    //         = 1;
    //       } else {
    //         throw InvalidDowncastException("Failed to downcast from Layer to
    //         GlobalAveragePooling2D (layer_name: " +
