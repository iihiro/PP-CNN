...
vector<vector<float>> loadMnistTestImages(const std::string& dataset_dir, const size_t& test_limit) {
  mnist::MNIST_dataset<vector, vector<float>, uint8_t> dataset =
      ...
      mnist::read_dataset<vector, vector, float, uint8_t>(dataset_dir, 1, test_limit);
...
vector<vector<float>> loadCifar10TestImages(const std::string& dataset_dir, const size_t& test_limit) {
  cifar::CIFAR10_dataset<vector, vector<uint8_t>, uint8_t> dataset =
      ...
      cifar::read_dataset<vector, vector, uint8_t, uint8_t>(dataset_dir, 1, test_limit);
...
vector<unsigned char> loadCifar10TestLabels(const std::string& dataset_dir, const size_t& test_limit) {
  cifar::CIFAR10_dataset<vector, vector<float>, uint8_t> dataset =
      ...
      cifar::read_dataset<vector, vector, float, uint8_t>(dataset_dir, 1, test_limit);
